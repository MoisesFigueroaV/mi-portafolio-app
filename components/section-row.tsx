...
export default function SectionRow({
  ...
  const pt =
    spacing === "xl"
      ? "pt-20 sm:pt-16 lg:pt-24"
      : spacing === "lg"
        ? "pt-16 sm:pt-12 lg:pt-20"
        : spacing === "md"
          ? "pt-12 sm:pt-10 lg:pt-16"
          : "pt-10 sm:pt-8"
      ...
      <div className="lg:grid lg:grid-cols-[220px_minmax(0,1fr)] lg:gap-10">
        ...
        <div className="mb-6 sm:mb-4 lg:hidden">
          <div className="flex items-center gap-2">
            ...
            {hint && <div className="text-sm sm:text-xs text-white/60">— {hint}</div>}
          </div>
        </div>
        ...
        <div className="mb-4 hidden lg:block">
          ...
          {icon && <div className="mt-3 text-white/60">{icon}</div>}
        </div>
